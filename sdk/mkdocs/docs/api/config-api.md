...
This configuration API is used to store the configuration of your plugin. Using this API ensures that your application configuration can be migrated properly to a new system in case you want to flash new firmware or migrate to a new hardware.
