...
func (self *Device) WalletTx(tx *sql.Tx, ctx context.Context) (models.IWallet, error) {
...
func (self *Device) NextSessionTx(tx *sql.Tx, ctx context.Context) (models.ISession, error) {
	return self.models.sessionModel.AvlForDevTx(tx, ctx, self.id)
}

func (self *Device) SessionsTx(tx *sql.Tx, ctx context.Context) ([]models.ISession, error) {
...
func (self *Device) Wallet(ctx context.Context) (models.IWallet, error) {
	tx, err := self.db.SqlDB().BeginTx(ctx, nil)
	if err != nil {
		return nil, err
	}
...
func (self *Device) NextSession(ctx context.Context) (models.ISession, error) {
	tx, err := self.db.SqlDB().BeginTx(ctx, nil)
	if err != nil {
		return nil, err
	}
...
func (self *Device) Sessions(ctx context.Context) ([]models.ISession, error) {
	tx, err := self.db.SqlDB().BeginTx(ctx, nil)
	if err != nil {
		return nil, err
	}
